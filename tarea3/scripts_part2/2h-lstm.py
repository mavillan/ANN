...
if __name__=='__main__':
    ...
    # generation of model
    model = generate_model(top_words, embedding_length, n_lstm_units=n_units, dropout=0.2)
    # fitting of model
    ...
    # saving the model
    save(model, 'lstm{2}_embedding{0}_tw{1}'.format(embedding_length, top_words, n_units), base_dir=base_dir)
