...
if __name__=='__main__':
    ...
    save_keras_model(model, 'mlp_768x{0}x{0}x10_pretrain_ae_relu'.format(n_hidden_layer))
    ...
    pickle.dump( hist.history, open( 'mlp_768x{0}x{0}x10_finetunning_ae_relu.hist'.format(n_hidden_layer), "wb" ) )
    save_keras_model(model, 'mlp_768x{0}x{0}x10_finetunning_ae_relu'.format(n_hidden_layer))
