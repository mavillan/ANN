...
if __name__=='__main__':
    ...
    save_keras_model(model, 'mlp_768x1000x1000x10_pretrain_relu')
    ...
    pickle.dump( hist.history, open( "mlp_768x1000x1000x10_finetunning_relu.hist", "wb" ) )
    save_keras_model(model, 'mlp_768x1000x1000x10_finetunning_relu')
