...
if __name__=='__main__':
    ...
    save_keras_model(model, 'mlp_768x1000x1000x10_pretrain_rbm_tanh')
    ...
    pickle.dump( hist.history, open( "mlp_768x1000x1000x10_finetunning_rbm_tanh.hist", "wb" ) )
    save_keras_model(model, 'mlp_768x1000x1000x10_finetunning_rbm_tanh')
