...
if __name__=='__main__':
    ...
    save_keras_model(model, 'mlp_768x1000x1000x10_pretrain_ae_reg')
    ...
    pickle.dump( hist.history, open( "mlp_768x1000x1000x10_finetunning_ae_reg.hist", "wb" ) )
    save_keras_model(model, 'mlp_768x1000x1000x10_finetunning_ae_reg')
