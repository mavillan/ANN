...
if __name__=='__main__':
    ...
    save_keras_model(model, 'mlp_768x1000x1000x10_pretrain')
    ...
    pickle.dump( hist.history, open( "mlp_768x1000x1000x10_finetunning.hist", "wb" ) )
    save_keras_model(model, 'mlp_768x1000x1000x10_finetunning')
